...
//        Car[] myCarArray = new Car[] {firstCar, secondCar };
        ...
        CarDealership dealership = new CarDealership("MyVolvo", 15);
        System.out.println(dealership.toString());
        System.out.println("-----------------");

        CarDealership dealership1 = new CarDealership("TheHonda", 10);
        System.out.println(dealership1.toString());
        System.out.println("-----------------");


        DealershipService dealershipService = new DealershipService(); // THIS OBJECT IS RETURNING THE NUMBER OF CARS THE DEALERSHIP CURRENTLY HAS IN STOCK
        System.out.println("Number of cars in the dealership:  " + dealershipService.countingCars(dealership));
