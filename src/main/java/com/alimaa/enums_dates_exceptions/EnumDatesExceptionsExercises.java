package com.alimaa.enums_dates_exceptions;
...
//        Exercise1TshirtSizeEnums tShirtSize[] = Exercise1TshirtSizeEnums.values();
        for (Exercise1TshirtSizeEnums tShirtSize:Exercise1TshirtSizeEnums.values()) {
            Exercise1TshirtSizeEnums.valueOf(tShirtSize.name().toUpperCase());

        }
//        System.out.println(Exercise1TshirtSizeEnums.valueOf(Exercise1TshirtSizeEnums));
